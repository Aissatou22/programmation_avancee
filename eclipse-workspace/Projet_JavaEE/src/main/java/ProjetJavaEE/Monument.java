...
public class Monument implements Serializable {
	...
	public String toString() {
		return "Monument [codeM=" + codeM + ", nomM=" + nomM + ", propietaire=" + propietaire + ", typeMonument="
				+ typeMonument + ", longitude=" + longitude + ", latitude=" + latitude + ", associeAcelebrites="
				+ associeAcelebrites + ", localisation=" + localisation + "]";
	}
